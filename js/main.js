...
const LANG = {
  en: {
    ...
    pathIntro: 'בהמשך להצלחות ראשוניות, יוזמות מחקר עתידיות ירחיבו את תחום החקירה, ישכללו פרוטוקולי טיפול ויעמיקו את הבנתנו של מנגנוני הריפוי של האיבוגאין. התרחבות אסטרטגית זו חיונית לביסוס האיבוגאין כטיפול נוירו-רסטורטיבי מקובל.',
    path1Title: 'ניסויים קליניים מורחבים',
    path1Text: 'מעבר ל-TBI ו-PTSD, מחקרים יחקרו את יעילות האיבוגאין במצבים נוירולוגיים ופסיכיאטריים נוספים, כולל דיכאון קשה, הפרעות חרדה ומצבים ניווניים, תוך שימוש בקבוצות גדולות ומגוונות יותר.',
    path2Title: 'הדמיה עצבית ובסמנים ביולוגיים',
    path2Text: 'fMRI מתקדם, סריקות PET וריצוף גנטי יחשפו את מעגלי העצב המדויקים והסמנים הביולוגיים הקשורים להשפעות תיקון המוח של האיבוגאין, ויסללו את הדרך לגישות רפואה מותאמת אישית.',
    path3Title: 'יעילות ובטיחות לטווח ארוך',
    path3Text: 'מחקרים אורכיים עוקבים אחר מטופלים במשך מספר שנים יספקו נתונים קריטיים על יתרונות טיפוליים מתמשכים, מניעת הישנות ופרופילי בטיחות לטווח ארוך.',
    pathClosing: 'מחקרים אלה יבצרו את מעמדה של ישראל כמובילה בנוירומדע פסיכדלי, ויחוללו מהפכה בפרדיגמות הטיפול במגוון מצבים מורכבים.',
