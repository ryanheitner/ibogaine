...
const LANG = {
  en: {
    ...
    "navContact": "Contact",
    "langToggle": "\u05e2\u05d1\u05e8\u05d9\u05ea",
    "heroLabel": "Israelis for Ibogaine",
    ...
    "ecoLabel": "Ecosystem",
    "ecoH2": "The Israelis for Ibogaine Umbrella",
    "ecoIntro": "Israelis for Ibogaine is designed to function as the <strong>central connective node</strong> of a broader national ecosystem, bridging academia, healthcare, civil society, and biotechnology.",
    ...
    "legalTaxText": "Israelis for Ibogaine is registered as a formal <strong>Amuta</strong> (Non-Profit Association) under the Israeli Ministry of Justice. We are not currently accepting donations; any future fundraising and tax treatment will be announced once formally established.",
    ...
    "legalEntityAddressLabel": "Registered Address:",
    "legalEntityAddressValue": "41 Yigal Yadin St., Modi’in-Maccabim-Re’ut 7171604, Israel",
    ...
    "imp3Text": "Standard care is failing. Israelis for Ibogaine offers a structured, evidence-driven, safety-first pathway to integrate a proven intervention responsibly and urgently.",
    "impactLabel": "Impact",
    ...
    "contactH2": "Contact Israelis for Ibogaine",
    ...
    "contactCity": "41 Yigal Yadin St., Modi’in-Maccabim-Re’ut 7171604, Israel",
    "footerDesc": "Israelis for Ibogaine is a non-profit organization dedicated to advancing ibogaine-assisted therapy for PTSD, TBI, addiction, and neurological conditions. We advocate for evidence-based policy, clinical access, and public education.",
    ...
    "footerLegalEntity": "This website is operated by Iboga Bush (R.A.) / \u05e1\u05e0\u05d4 \u05d0\u05d9\u05d1\u05d5\u05d2\u05d4 (\u05e2\u201d\u05e8), Israeli nonprofit registration no. 580841922. Registered address: 41 Yigal Yadin St., Modi’in-Maccabim-Re’ut 7171604, Israel.",
    ...
    heroLabel: 'ישראלים למען איבוגאין',
    ...
    heVideo4Desc: 'ראיון לילי מעמיק עם בועז וכטל, מחלוצי האיבוגאין בישראל, אצל אברי גלעד ויעקב שרקי בקשת 12 — על איבוגאין כפריצת דרך אפשרית לטיפול ב-PTSD, בפגיעות ראש טראומטיות ובהתמכרויות, ועל המאמץ לקדם מחקר ונגישות בישראל.',
    ...
    contactEmail: 'info@israelisforibogaine.org',
    contactCity: 'רא״ל יגאל ידין 41, מודיעין-מכבים-רעות 7171604',
    ...
    ecoH2: 'מטריית ישראלים למען איבוגאין',
    ecoIntro: '"ישראלים למען איבוגאין" מתוכננת לתפקד כ<strong>צומת המחברת המרכזית</strong> של מערכת אקולוגית לאומית רחבה, ומגשרת בין האקדמיה, מערכת הבריאות, החברה האזרחית והביוטכנולוגיה.',
    ...
    legalTaxText: '"ישראלים למען איבוגאין" רשומה כ<strong>עמותה</strong> רשמית ברשם העמותות במשרד המשפטים. איננו מקבלים תרומות בשלב זה; כל גיוס כספים עתידי ומעמד מס יפורסמו לאחר שיוסדרו באופן רשמי.',
    ...
    legalEntityAddressLabel: 'כתובת רשומה:',
    legalEntityAddressValue: 'רא״ל יגאל ידין 41, מודיעין-מכבים-רעות 7171604',
    ...
    imp3Text: 'הטיפול הסטנדרטי מאכזב. "ישראלים למען איבוגאין" מציעה מסלול מובנה, מבוסס ראיות ובטיחותי לשילוב אחראי ודחוף של התערבות מוכחת.',
    ...
    footerDesc: 'ישראלים למען איבוגאין היא עמותה ללא מטרות רווח הפועלת לקידום טיפול בסיוע איבוגאין לטיפול ב-PTSD, בפגיעות ראש טראומטיות, בהתמכרויות ובמצבים נוירולוגיים. אנו תומכים במדיניות מבוססת ראיות, בנגישות קלינית ובחינוך הציבור.',
    ...
    footerLegalEntity: 'אתר זה מופעל על ידי סנה איבוגה (ע”ר) / Iboga Bush (R.A.), עמותה רשומה בישראל מס׳ 580841922. כתובת רשומה: רא״ל יגאל ידין 41, מודיעין-מכבים-רעות 7171604.',
